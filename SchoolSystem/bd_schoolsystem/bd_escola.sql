...
#Aluna: Eloizy Campi Reis   3º A INF
...
insert into escola values (null, 'Joaquim de Lima Avelino', 'Joaquim Avelino de Lima Filho', '11.222.333/0001-02', '1980101022009-0', 'Público', '1980-02-10', 'Eduardo Silva', '69 99234-5678', 'eduardosilva@gmail.com', '69 99323-4252', 'Juscelino Kubitscheck', '125', 'Jardim Tropical', 'escola', '76920-000', 'Ouro Preto do Oeste', 'Rondônia');

create table Curso(
id_cur int primary key auto_increment,
nome_cur varchar(200) not null,
carga_horaria_cur time not null,
turno_cur varchar(50) not null,
descricao_cur varchar(100)
);

insert into curso values(null, 'Informática', 200, 'Matutino', null);